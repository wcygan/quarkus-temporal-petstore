...
public class TemporalActivityObserver {
    ...
    @Inject
    OrderServiceActivitiesImpl activity;
    ...
    void onStart(@Observes StartupEvent ev) {
        ...
        WorkflowClientOptions clientOptions = WorkflowClientOptions.newBuilder()
                .setIdentity("OrderService-" + ManagementFactory.getRuntimeMXBean().getName())
        ...
        factory.start();
        log.infof("Order Service Activity Worker started for task queue: %s", taskQueue);
    }
