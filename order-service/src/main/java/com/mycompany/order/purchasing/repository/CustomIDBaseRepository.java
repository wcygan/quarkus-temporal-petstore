...
public class CustomIDBaseRepository<T, ID> implements PanacheRepositoryBase<T, ID> {
     ...
     */
    @Timed(value = "repo.custom.id.base.saveOrUpdate", description = "Saves or updates an entity")
     ...
     */
    @Timed(value = "repo.custom.id.base.saveOrUpdate.list", description = "Saves or updates list of entity")
     ...
     */
    @Timed(value = "repo.custom.id.base.saveOrUpdate.set", description = "Saves or updates Set of entity")
