...
/**
 * This class attempts to connect to the Temporal server on Quarkus startup and
 * will also close any connections on shutdown
 *
...
public class TemporalActivityObserver {
    ...
    @Inject
    ShipperActivitiesImpl activity;
    ...
    void onStart(@Observes StartupEvent ev) {
        ...
        WorkflowClientOptions clientOptions = WorkflowClientOptions.newBuilder()
                .setIdentity("ShipperService-" + ManagementFactory.getRuntimeMXBean().getName())
        ...
        factory.start();
        log.infof("Shipper Service Activity Worker started for task queue: %s", taskQueue);
    }
