...
public class TemporalActivityObserver {
    ...
    @Inject
    WarehouseActivitiesImpl activity;
    ...
    void onStart(@Observes StartupEvent ev) {
        ...
        WorkflowClientOptions clientOptions = WorkflowClientOptions.newBuilder()
                .setIdentity("WarehouseService-" + ManagementFactory.getRuntimeMXBean().getName())
        ...
        factory.start();
        log.infof("Warehouse Service Activity Worker started for task queue: %s", taskQueue);
    }
